...
{
    public class UserTypeTBLRepository : GenericRepository<UserTypeTBL>, IUserTypeTBLRepository
    {
        private readonly AymanFreelanceDbContext _context;

        public UserTypeTBLRepository(AymanFreelanceDbContext context) :base(context)
        {
            _context = context;
        }
